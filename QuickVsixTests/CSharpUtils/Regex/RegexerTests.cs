...
public class RegexerTests
{
   ...
   [Test]
   public void MatchAndGetGroup_AllEmptyStrings_ReturnsEmptyString()
   {
      string groupMatchValue = _regexer.MatchAndGetGroup(input: "", pattern: "", groupName: "");
      Assert.AreEqual("", groupMatchValue);
   }
