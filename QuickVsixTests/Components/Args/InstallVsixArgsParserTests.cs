...
public class InstallVsixArgsParserTests
{
   ...
   {
      string vsixFilePath = Mock.ReturnRandomString(() => p_docoptParserMock.GetRequiredFilePathArgumentWhichMustAlreadyExist(null, null));
      ...
      //
      Called.Once(() => p_docoptParserMock.GetRequiredFilePathArgumentWhichMustAlreadyExist(docoptDictionary, "--vsix-file")).Then(
